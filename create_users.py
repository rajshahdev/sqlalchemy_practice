...
new_post = Posts(title = 'rahbkbkadbsasdk asjkdb', description = 'ajbskabsa abskbskakbaksba kjbaskjbakbaskjbaksbkabska kjabskjabkbsakjbkabska kjabskasbajksbak', user_id=1)
